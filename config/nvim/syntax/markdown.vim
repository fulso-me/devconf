...
" Recognize jekyll
syn region lqdHighlight     start=/^{%\s*highlight\(\s\+\w\+\)\{0,2}\s*%}$/ end=/{%\s*endhighlight\s*%}/ contains=@Spell
syn region jkyFrontMatter   start=/\%^---$/                                 end=/^---$/                  contains=@Spell
hi def link lqdHighlight     String
hi def link jkyFrontMatter   String
" end jekyll
